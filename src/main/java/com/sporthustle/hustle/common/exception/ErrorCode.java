...
public enum ErrorCode {
  ...
  CLUB_POST_COMMENT_LIKE_NOT_FOUND(
      BAD_REQUEST, "CLUB_POST_COMMENT_LIKE_NOT_FOUND", "동아리 게시글 댓글을 추천한 적이 없습니다."),
  CLUB_POST_COMMENT_LIKE_ALREADY_CREATED(
      BAD_REQUEST, "CLUB_POST_COMMENT_LIKE_ALREADY_CREATED", "동아리 게시글 댓글을 추천한 적이 있습니다."),
  ;
